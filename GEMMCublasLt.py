...
class GEMMCublastLt:
    ...
    def build(self):
        ...
        path = "Benchmarks/superbenchmark"
        ...
        build_path = os.path.join(
            current,
            "Benchmarks/superbenchmark/superbench/benchmarks/micro_benchmarks/cublaslt_gemm",
        )
        os.chdir(build_path)
    ...
    def plot_shmoo(self):
        ...
        model_arr = np.array(self.parse_csv("Outputs/GEMMCublasLt_Performance_" + self.machine_name + "_fp8e4m3.csv"))

        # roofline.plot_points(m_arr, "lime", "GEMMCublasLt_M Sweep_" + self.machine_name, self.datatype)
        # roofline.plot_points(n_arr, "blue", "GEMMCublasLt_N Sweep_" + self.machine_name, self.datatype)
        # roofline.plot_points(k_arr, "green", "GEMMCublasLt_K Sweep_" + self.machine_name, self.datatype)
        # roofline.plot_points(model_arr, "red", "Model_sizes", self.datatype)
        plt.close()
